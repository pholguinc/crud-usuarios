      ...
      <div class="border-0 card radius-10 border-start border-3 border-info">
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div
              class="text-white widgets-icons-2 rounded-circle bg-gradient-scooter ms-auto"
            >
      ...
      <div class="border-0 card radius-10 border-start border-3 border-danger">
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div
              class="text-white widgets-icons-2 rounded-circle bg-gradient-bloody ms-auto"
            >
      ...
      <div class="border-0 card radius-10 border-start border-3 border-warning">
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div
              class="text-white widgets-icons-2 rounded-circle bg-gradient-blooker ms-auto"
            >
      ...
      <div class="card radius-10">
        <div class="card-body">
          ...
          <div class="gap-2 my-3 d-flex align-items-center ms-auto font-13">
            <span class="px-1 border rounded cursor-pointer"
        ...
        <div
          class="text-center row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group border-top"
        >
          <div class="col">
            <div class="p-3">
              ...
              <small class="mb-0"
                >Overall Visitor
                <span>
                  <i class="align-middle bx bx-up-arrow-alt"></i>
                  2.43%</span
                ></small
              >
            </div>
    ...
    <div class="col-12 col-lg-4">
      <div class="card radius-10">
        ...
        <ul class="list-group list-group-flush">
          <li
            class="bg-transparent list-group-item d-flex justify-content-between align-items-center"
          >
        ...
        <table class="table mb-0 align-middle">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span
                  class="text-white shadow-sm badge bg-gradient-quepal w-100"
                  >Paid</span
                >
              </td>
              <td>$1250.00</td>
            ...
            <tr>
              ...
              <td>
                <span
                  class="text-white shadow-sm badge bg-gradient-blooker w-100"
                  >Pending</span
                >
              </td>
              <td>$1500.00</td>
            ...
            <tr>
              ...
              <td>
                <span
                  class="text-white shadow-sm badge bg-gradient-bloody w-100"
                  >Failed</span
                >
              </td>
              <td>$1400.00</td>
          ...
          <div class="border shadow-none card radius-10">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div
                  class="text-white widgets-icons-2 bg-gradient-cosmic ms-auto"
                >
          ...
          <div class="border shadow-none card radius-10">
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <div
                  class="text-white widgets-icons-2 bg-gradient-ibiza ms-auto"
                >
        ...
        <div class="card-body">
          ...
          <div class="mb-4 d-flex align-items-center">
            ...
            <div class="">
              ...
              >
                4.4% <i class="mr-2 bx bxs-up-arrow-alt"></i>
              </p>
            </div>
          </div>
...
$(".mobile-toggle-menu").on("click", function() {
		...
		$(function() {
			for (var e = window.location, o = $(".metismenu li a").filter(function() {
                ...
                o.is("li");) o = o.parent("").addClass("mm-show").parent("")
                .addClass("mm-active")
		}),
		$(function() {
			$("#menu").metisMenu()
